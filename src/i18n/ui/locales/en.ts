export const enUiMessages = {
  ...
  'dialog.addKey.description': 'Enter a new translation key (for example, home.title).',
  'dialog.addKey.placeholder': 'home.title',
  'dialog.deleteKey.title': 'Delete key?',
  'dialog.deleteKey.confirmWithKey': 'Are you sure you want to delete key "{key}"?',
  'dialog.deleteKey.confirmGeneric': 'Are you sure you want to delete this key?',
  'dialog.clearAll.title': 'Clear all data?',
  'dialog.clearAll.description': 'This will remove all imported translations, your API key, and IndexedDB data.',
  ...
  'settings.apiKeyDescription': 'OPENAI_API_KEY from https://platform.openai.com/api-keys',
  'settings.apiKeyLabel': 'OPENAI_API_KEY',
  'settings.hiddenHint': 'The field is hidden as a password; the key is only visible to you locally.',
  ...
  'openai.error.missingApiKey': 'Please enter OPENAI_API_KEY in settings first.',
  'openai.error.requestFailed': 'OpenAI request failed. Check your API key or quota.',
